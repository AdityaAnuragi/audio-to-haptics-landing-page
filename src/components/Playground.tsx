        ...
        {PRESETS.map(p => (
          <button
            ...
            style={{
              padding: '6px 14px',
              borderRadius: 20,
              border: preset === p.key ? '1.5px solid rgba(124,58,237,0.5)' : '1px solid rgba(255,255,255,0.6)',
              background: preset === p.key ? 'rgba(255,255,255,0.65)' : 'rgba(255,255,255,0.35)',
              backdropFilter: 'blur(16px)',
              WebkitBackdropFilter: 'blur(16px)',
              color: preset === p.key ? '#7c3aed' : '#444',
              fontSize: 13,
              fontWeight: 600,
              cursor: 'pointer',
            }}
